...
const ua: LocaleData = {
  welcome:
    ...
    `Зараз доступ до VPN відкритий лише для гаманців, на яких є від 1 000 000 $PLANKTON\\.\n` +
  ...
  not_enough_plankton: 'Недостатньо $PLANKTON для холдерського доступу.\nЗараз доступ до VPN відкритий лише для гаманців, на яких є від 1 000 000 $PLANKTON.',
  ...
  help_text:
    ...
    `Гаманці, на яких є від 1 000 000 $PLANKTON\\.\n\n` +
    `*Що якщо токенів менше?*\n` +
    `Доступ поки не буде активовано\\. Платні тарифи скоро\\.\n\n` +
