...
const ua: LocaleData = {
  welcome:
    ...
    `Усе керування VPN знаходиться всередині Web App\\.\n` +
    `Натисніть *Launch App*, щоб підключити гаманець, перевірити доступ, купити підписку, керувати пристроями та завантажити конфіги\\.`,
  ...
  help_text:
    ...
    `Усе керування VPN знаходиться всередині Web App\\.\n\n` +
    `Відкрийте *Launch App*, щоб підключити гаманець, перевірити доступ, купити підписку, керувати пристроями та завантажити конфіги WireGuard або Amnezia\\.\n\n` +
