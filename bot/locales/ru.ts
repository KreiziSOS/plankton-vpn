...
const ru: LocaleData = {
  welcome:
    ...
    `Сейчас доступ к VPN открыт только для кошельков, на которых есть от 1 000 000 $PLANKTON\\.\n` +
  ...
  not_enough_plankton: 'Недостаточно $PLANKTON для холдерского доступа.\nСейчас доступ к VPN открыт только для кошельков, на которых есть от 1 000 000 $PLANKTON.',
  ...
  help_text:
    ...
    `Кошельки, на которых есть от 1 000 000 $PLANKTON\\.\n\n` +
    `*Что если токенов меньше?*\n` +
    `Доступ пока не будет активирован\\. Платные тарифы скоро\\.\n\n` +
