...
const TEXT = {
  en: {
    title: 'PLANKTON VPN',
    subtitle: 'Holders-only beta for wallets with at least 1,000,000 $PLANKTON.',
    hold: 'Access is currently available only for wallets holding at least 1,000,000 $PLANKTON.',
    check: 'Check Access',
    checking: 'Checking...',
    ...
    holderDuration: 'Holder VPN access from 1,000,000 $PLANKTON',
    comingSoon: 'Coming soon',
    marketIntro: 'Paid VPN plans are being prepared for the next release.',
    betaAccessTitle: 'Holders-only beta',
    betaAccessText: 'Plankton VPN is in holders-only beta. Access is currently available only for wallets holding at least 1,000,000 $PLANKTON. Connect your wallet, check access, then create WireGuard, Amnezia, or OpenVPN configs.',
    paidComingSoonTitle: 'Paid plans are coming soon',
    paidComingSoonText: 'Subscriptions will unlock broader device limits and longer access. During early access, VPN creation is reserved for wallets holding at least 1,000,000 $PLANKTON.',
    ...
    planktonWalletMissing: 'Could not find your PLANKTON wallet. Access requires at least 1,000,000 $PLANKTON.',
  ...
  ru: {
    title: 'PLANKTON VPN',
    subtitle: 'Holders-only beta для кошельков с балансом от 1 000 000 $PLANKTON.',
    hold: 'Сейчас доступ к VPN открыт только для кошельков, на которых есть от 1 000 000 $PLANKTON.',
    ...
    holderDuration: 'Холдерский VPN-доступ от 1 000 000 $PLANKTON',
    comingSoon: 'Скоро',
    marketIntro: 'Платные VPN-тарифы готовятся к следующему релизу.',
    betaAccessTitle: 'Holders-only beta',
    betaAccessText: 'Plankton VPN работает в формате holders-only beta. Сейчас доступ к VPN открыт только для кошельков, на которых есть от 1 000 000 $PLANKTON. Подключи кошелёк, проверь доступ и создай конфиг WireGuard, Amnezia или OpenVPN.',
    paidComingSoonTitle: 'Платные тарифы скоро',
    paidComingSoonText: 'Подписки откроют расширенные лимиты устройств и более долгий доступ. На этапе early access создание VPN доступно кошелькам с балансом от 1 000 000 $PLANKTON.',
    ...
    planktonWalletMissing: 'Не удалось найти твой PLANKTON wallet. Для доступа нужно от 1 000 000 $PLANKTON.',
  ...
  ua: {
    title: 'PLANKTON VPN',
    subtitle: 'Holders-only beta для гаманців з балансом від 1 000 000 $PLANKTON.',
    hold: 'Зараз доступ до VPN відкритий лише для гаманців, на яких є від 1 000 000 $PLANKTON.',
    ...
    holderDuration: 'Холдерський VPN-доступ від 1 000 000 $PLANKTON',
    comingSoon: 'Скоро',
    marketIntro: 'Платні VPN-тарифи готуються до наступного релізу.',
    betaAccessTitle: 'Holders-only beta',
    betaAccessText: 'Plankton VPN працює у форматі holders-only beta. Зараз доступ до VPN відкритий лише для гаманців, на яких є від 1 000 000 $PLANKTON. Підключи гаманець, перевір доступ і створи конфіг WireGuard, Amnezia або OpenVPN.',
    paidComingSoonTitle: 'Платні тарифи скоро',
    paidComingSoonText: 'Підписки відкриють розширені ліміти пристроїв і довший доступ. На етапі early access створення VPN доступне гаманцям з балансом від 1 000 000 $PLANKTON.',
    ...
    planktonWalletMissing: 'Не вдалося знайти твій PLANKTON wallet. Для доступу потрібно від 1 000 000 $PLANKTON.',
  ...
  zh: {
    title: 'PLANKTON VPN',
    subtitle: '面向持有至少 1,000,000 $PLANKTON 钱包的 holders-only beta。',
    hold: '目前 VPN 仅对持有至少 1,000,000 $PLANKTON 的钱包开放。',
    check: '检查权限',
    checking: '检查中...',
    active: 'VPN 已激活',
    locked: '访问受限',
    ...
    holderFree: '持有者 / 免费',
    holderDuration: '1,000,000 $PLANKTON 起的持有者 VPN 访问',
    comingSoon: '即将推出',
    marketIntro: '付费 VPN 套餐正在为下一版本准备。',
    betaAccessTitle: '持有者专属 beta',
    betaAccessText: 'Plankton VPN 当前处于 holders-only beta。目前 VPN 仅对持有至少 1,000,000 $PLANKTON 的钱包开放。连接钱包、检查权限，然后创建 WireGuard、Amnezia 或 OpenVPN 配置。',
    paidComingSoonTitle: '付费套餐即将推出',
    paidComingSoonText: '订阅将解锁更高设备限制和更长访问时间。Early access 阶段仅持有至少 1,000,000 $PLANKTON 的钱包可创建 VPN。',
    ...
    planktonWalletMissing: '找不到你的 PLANKTON 钱包。访问需要至少 1,000,000 $PLANKTON。',
